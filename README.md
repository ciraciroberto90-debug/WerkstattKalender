...
| `tests/` | 82 Härtetests, fünf Browser-Reserve-Tests und weitere Suiten | Entwicklung |
...
| [`UPDATE-VORMERKUNGEN.md`](UPDATE-VORMERKUNGEN.md) | **vorgemerkte Updates** – besprochen und für gut befunden, aber noch nicht gebaut |
...
| [`doku/BTA-Cockpit-Hauptpraesentation.pptx`](doku/BTA-Cockpit-Hauptpraesentation.pptx) | **Hauptpräsentation für beide Firmen** – 23 Folien, firmenneutral: Vorher/Heute, Bildschirmfotos aller Bereiche, Rollen & Rechte, Personalisieren, mehrere Werkstätten, Verlässlichkeit, Kosten, Kaufsoftware-Vergleich, Ausblick (Stand 21.09., Bauskripte in `doku/hauptpraesentation/`) |
| [`doku/BTA-Cockpit-Vorstellung.pptx`](doku/BTA-Cockpit-Vorstellung.pptx) | **lange Fassung** für die Vorstellung bei Soendgen Keramik am 22.09. – 42 Folien, 7 Kapitel inkl. Entstehung mit Claude (Stand 19.09., Bauskripte in `doku/vorstellung-bta-cockpit/`) |
...
bash tests/run-hardness-tests.sh           # 82 Härtetests (vor jedem Push)
