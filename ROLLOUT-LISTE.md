...
- [x] **GEBAUT (11.09., Robertos „ja bauen"): Jahres-Archiv von Hand
      aufrufbar.** Neuer Knopf „Jahres-Archiv öffnen …" im ⚙ → Verlauf &
      Sicherung: öffnet dieselbe Auslagern-Karte wie die automatische
...
15. ~~Klick auf eine Kachel öffnet ihre Pflegestelle~~ (Roberto 24.09.: „lässt mich die Details dazu bearbeiten, in diesem Fall Unfälle") – **GEBAUT 24.09.** (harte-91, 13 Prüfungen; Kachel = Knopf mit Hinweis im Tooltip): `kachelZiel` je Kennzahl – Unfälle/Kosten ins ⚙ Regeln & Listen mit Sprung zum Abschnitt (`openSettings(tab, sprung)`, nur Verwalter), Störungen/To-dos/Backlog/Zeit in die Berichte, Jetzt da in den Schichtplan, Termine/Quoten in den TPM-Plan; Rechte-Matrix gilt, im Anordnen-Modus eingefroren. **Volle Suite: 82/83 grün**, harte-42 (6) unter Suiten-Last rot (Anmeldung nach 500 ms noch nicht durch), allein 38/38 grün – Prüfstand wartet jetzt auf das Schließen des Dialogs.
16. **Teams in einer Kachel?** (Robertos Frage 24.09.: „Kanal oder Chat oder so etwas Ähnliches") – **Antwort gegeben, Entscheidung offen.** Was ohne IT geht: eine Teams-Kachel mit Sprung-Links (Kanal öffnen, Chat mit Person, vorausgefüllte Nachricht z. B. aus einem Störbericht) – Teams öffnet sich daneben. Was nicht geht: Kanal/Chat *in* der Kachel anzeigen (Teams lässt sich nicht einbetten, Lesen braucht eine App-Freigabe durch die IT). Dazwischen, ungemessen: Nachricht aus dem Cockpit in einen Kanal schicken über einen Workflow-Webhook, den Roberto selbst in Teams anlegt – ob der Firmen-Tenant das erlaubt und ob es aus der Datei heraus funktioniert, muss am Werkstatt-Rechner gemessen werden. Vorlagen T1–T3 auf Wunsch. **Nachfrage Mails (24.09.):** dasselbe Bild – Postfach anzeigen braucht IT, Mail *schreiben* geht ohne (Mail-Link mit Empfänger/Betreff/Text öffnet Outlook, ohne Anhang); Rückweg ins Cockpit nur über die gemeinsame Datei. **Outlook (24.09.):** zusätzlich ohne IT möglich – Termindatei (.ics) aus PitStop/R+I/To-do-Frist, die Outlook als Kalendereintrag mit Erinnerung öffnet (auch als Einladung an Kollegen); ob sie am Werkstatt-Rechner ohne Nachfrage in Outlook landet, ist ungemessen (Dateiverknüpfung).
